...
def main():
    ...
    parser.add_argument("--train",             default="mmlu_ood_choice_out_of_question/train.jsonl")
    parser.add_argument("--dev",               default="mmlu_ood_choice_out_of_question/test.jsonl")
